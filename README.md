# [BOOOM](https://booomdigital.nl/)

## Additions

* Remove styleling
* Eslint disable
* ACF Builder install stoutlogic/acf-builder
* ACF Sage Directives install composer require log1x/sage-directives
* Swiper install SwiperJS
* WP Login/password-reset page + styling and scripts
...
* In config.json, edit "publicPath" and "devUrl" to the correct theme name and site url.
* In wordpress navigate to "menu" and setup all the fields.
